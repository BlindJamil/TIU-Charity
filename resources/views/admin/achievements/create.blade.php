    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-200">Create New Achievement</h1>
            </div>
            <p class="text-gray-400">Add a new completed project to showcase your impact</p>
        </div>

        <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data" x-data="achievementForm()">
            @csrf
            @if ($errors->any())
            ...
            <div class="bg-gray-800 rounded-lg p-6 mb-6 border border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="volunteers" id="volunteers" value="{{ old('volunteers') }}" required min="0"
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" id="description" rows="3" required maxlength="500"
                              ...
                              class="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="detailed_description" id="detailed_description" rows="6" required
                              ...
                              class="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 @error('detailed_description') border-red-500 @enderror">{{ old('detailed_description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <input type="text" name="impact_stat_1_value" placeholder="400" value="{{ old('impact_stat_1_value') }}" required
                            ...
                            <input type="text" name="impact_stat_1_label" placeholder="Students" value="{{ old('impact_stat_1_label') }}" required
                                   class="bg-gray-700 border border-gray-600 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <input type="text" name="impact_stat_2_value" placeholder="15" value="{{ old('impact_stat_2_value') }}" required
                                   class="bg-gray-700 border border-gray-600 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                            <input type="text" name="impact_stat_2_label" placeholder="Teachers" value="{{ old('impact_stat_2_label') }}" required
                                   class="bg-gray-700 border border-gray-600 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        </div>
                    </div>
                </div>
                    ...
                    <div id="detailed-stats-container">
                        <template x-for="(stat, index) in detailedStats" :key="index">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3 p-4 bg-gray-700 rounded-lg">
                                <input type="text" :name="`detailed_stats[${index}][value]`" placeholder="Value (e.g., 8)" x-model="stat.value"
                                ...
                                <input type="text" :name="`detailed_stats[${index}][label]`" placeholder="Label (e.g., Classrooms)" x-model="stat.label"
                                       class="bg-gray-600 border border-gray-500 rounded-lg p-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                                <input type="text" :name="`detailed_stats[${index}][description]`" placeholder="Description (optional)" x-model="stat.description"
                                       class="bg-gray-600 border border-gray-500 rounded-lg p-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500">
            ...
            <div class="bg-gray-800 rounded-lg p-6 mb-6 border border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-1">Main image for the project card</p>
                    </div>
                    
                    <div>
                        <label for="gallery_photos" class="block text-sm font-medium text-gray-300 mb-2">Gallery Photos</label>
                        <input type="file" name="gallery_photos[]" id="gallery_photos" accept="image/*" multiple
                               class="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-yellow-500 file:text-black hover:file:bg-yellow-600">
                        <p class="text-gray-400 text-xs mt-1">Multiple images for the project gallery</p>
                    </div>
                </div>
            </div>
...
function achievementForm() {
    return {
        ...
        testimonials: [],
        init() {
            // Repopulate from old input if available
            this.detailedStats = @json(old('detailed_stats', []));
            this.financialBreakdown = @json(old('financial_breakdown', []));
            this.accomplishments = @json(old('accomplishments', []));
        },
        addDetailedStat() {
