...
<section class="pt-16 bg-cover bg-center min-h-screen flex items-center justify-center relative" style="background-image: url('{{ asset('assets/img/Home-Hero.jpg') }}');">
  ...
  <div class="relative z-10 text-center px-4 py-20 max-w-6xl mx-auto">
      ...
      <div class="flex flex-col md:flex-row justify-center gap-8 mt-8 items-center">
          <!-- Donate Option -->
          <div class="bg-gray-900 bg-opacity-80 p-8 rounded-xl shadow-xl border border-gray-700 flex flex-col items-center max-w-md w-full mx-auto md:w-1/2 transition-transform hover:transform hover:scale-105">
