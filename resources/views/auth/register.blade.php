...
const emailBtn = document.getElementById('choose-email');
const phoneBtn = document.getElementById('choose-phone');
const emailField = document.getElementById('email-field');
const phoneField = document.getElementById('phone-field');

emailBtn.addEventListener('click', function() {
    emailBtn.classList.add('bg-yellow-500', 'text-black');
    emailBtn.classList.remove('bg-gray-700', 'text-white');
    phoneBtn.classList.remove('bg-yellow-500', 'text-black');
    phoneBtn.classList.add('bg-gray-700', 'text-white');
...
phoneBtn.addEventListener('click', function() {
    phoneBtn.classList.add('bg-yellow-500', 'text-black');
    phoneBtn.classList.remove('bg-gray-700', 'text-white');
    emailBtn.classList.remove('bg-yellow-500', 'text-black');
    emailBtn.classList.add('bg-gray-700', 'text-white');
